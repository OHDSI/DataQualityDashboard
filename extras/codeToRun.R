...
sqlOnly <- FALSE # set to TRUE if you just want to get the SQL scripts and not actually run the queries.  See codeToRun_sqlOnly.R for other parameters needed if sqlOnly = TRUE.

...
- *Numerator*: The number of rows with a value of 0 in the `_source_concept_id` source concept field.  For non-required fields, also includes rows where the `_source_concept_id` field is NULL and the corresponding `_source_value` field is not NULL.
- *Denominator*: The total number of rows in the table where the `_source_concept_id` field is not NULL or, for non-required fields, the corresponding `_source_value` field is not NULL.

...
- *Numerator*: The number of rows with a value of 0 in the `_concept_id` standard concept field. For non-required fields, also includes rows where the `_concept_id` field is NULL.
- *Denominator*: The total number of rows in the table where the `_concept_id` field is not NULL or, for non-required fields, the corresponding source value is not NULL.

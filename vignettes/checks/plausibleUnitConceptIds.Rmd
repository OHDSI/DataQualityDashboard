...
- *Numerator*: For a given `concept_id`, the number of rows in the measurement table with a non-zero `unit_concept_id` that is not in the list of plausible unit concept ids.
...
- *Denominator*: The total number of rows in the measurement table with a given `concept_id` and a NULL or non-zero `unit_concept_id`.

...
# 3. In the results output by the sqlOnlyIncrementalInsert queries, placeholders are populated for execution_time and query_text, and the NOT_APPLICABLE rules are not applied.
